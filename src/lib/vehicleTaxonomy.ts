...
export const POPULAR_MODELS: Record<string, string[]> = {
    ...
    'Alfa Romeo': ['Giulia', 'Stelvio', 'Tonale', '4C', 'MiTo', 'Giulietta', 'Brera', '159', 'GTV'],
    'Aston Martin': ['Vantage', 'DB11', 'DBS', 'DBX', 'Vanquish', 'Rapide'],
    'Audi': ['A1', 'A3', 'A4', 'A5', 'A6', 'A7', 'A8', 'Q2', 'Q3', 'Q5', 'Q7', 'Q8', 'TT', 'R8', 'e-tron', 'RS3', 'RS5', 'RS6', 'RS7', 'RS Q8', 'A3 Sedan', 'S3', 'S4', 'S5'],
    'BMW': ['Serie 1', 'Serie 2', 'Serie 3', 'Serie 4', 'Serie 5', 'Serie 7', 'Serie 8', 'X1', 'X2', 'X3', 'X4', 'X5', 'X6', 'X7', 'Z4', 'M2', 'M3', 'M4', 'M5', 'M8', 'i3', 'i4', 'iX', 'i7', 'iX3'],
    'BYD': ['Dolphin', 'Yuan Plus', 'Han', 'Tang', 'Seal', 'Song Plus'],
    'Buick': ['Encore', 'Envision', 'Enclave', 'LaCrosse', 'Regal'],
    'Cadillac': ['CT4', 'CT5', 'XT4', 'XT5', 'XT6', 'Escalade', 'Lyriq', 'Celestiq'],
    'Chevrolet': ['Aveo', 'Spark', 'Beat', 'Sonic', 'Cruze', 'Malibu', 'Camaro', 'Corvette', 'Trax', 'Tracker', 'Equinox', 'Blazer', 'Traverse', 'Tahoe', 'Suburban', 'Silverado', 'Cheyenne', 'Colorado', 'S10', 'Tornado', 'Cavalier', 'Onix', 'Captiva', 'Groove', 'Montana', 'Bolt EUV'],
    'Chrysler': ['300', 'Pacifica', 'Voyager', 'Town & Country'],
    'Cupra': ['Formentor', 'Leon', 'Ateca', 'Born', 'Tavascan'],
    'Dodge': ['Attitude', 'Neon', 'Charger', 'Challenger', 'Durango', 'Journey', 'Grand Caravan', 'RAM 1500', 'RAM 2500', 'Dart', 'Avenger'],
    'Ferrari': ['488', 'F8 Tributo', 'SF90', 'Roma', 'Portofino', '296 GTB', 'Purosangue', '812 Superfast'],
    'Fiat': ['500', '500X', 'Tipo', 'Panda', 'Argo', 'Cronos', 'Mobi', 'Toro', 'Pulse', 'Fastback'],
    'Ford': ['Fiesta', 'Focus', 'Figo', 'Fusion', 'Mustang', 'EcoSport', 'Escape', 'Edge', 'Explorer', 'Expedition', 'Bronco', 'Bronco Sport', 'Ranger', 'F-150', 'Lobo', 'Maverick', 'Transit', 'Transit Courier', 'Territory', 'Mach-E'],
    'GMC': ['Sierra', 'Canyon', 'Terrain', 'Acadia', 'Yukon', 'Savana', 'Hummer EV'],
    'Honda': ['Civic', 'City', 'Fit', 'Accord', 'Insight', 'CR-V', 'HR-V', 'BR-V', 'Pilot', 'Odyssey', 'Ridgeline', 'Element', 'Passport', 'CBR1000RR', 'CBR600RR', 'CBR500R', 'CBR300R', 'CB1000R', 'CB650R', 'CB500F', 'CRF1100 Africa Twin', 'Gold Wing', 'Rebel 500', 'Rebel 1100', 'Shadow', 'Grom', 'Navi', 'Dio', 'Elite', 'PCX', 'Cargo'],
    'Hyundai': ['Grand i10', 'Accent', 'Elantra', 'Sonata', 'Creta', 'Tucson', 'Santa Fe', 'Palisade', 'Venue', 'Staria', 'H100', 'Ioniq 5', 'Ioniq 6', 'HB20'],
    'Infiniti': ['Q50', 'Q60', 'QX50', 'QX55', 'QX60', 'QX80'],
    'Jaguar': ['XE', 'XF', 'XJ', 'F-Type', 'E-Pace', 'F-Pace', 'I-Pace'],
    'Jeep': ['Wrangler', 'Rubicon', 'Sahara', 'Gladiator', 'Cherokee', 'Grand Cherokee', 'Compass', 'Renegade', 'Patriot', 'Commander', 'Wagoneer', 'Grand Wagoneer', 'Avenger'],
    'Kia': ['Rio', 'Forte', 'K3', 'Optima', 'Stinger', 'Soul', 'Seltos', 'Sportage', 'Sorento', 'Telluride', 'Niro', 'Sedona', 'Carnival', 'EV6', 'EV9'],
    ...
    'Mercedes-Benz': ['Clase A', 'Clase B', 'Clase C', 'Clase E', 'Clase S', 'CLA', 'CLS', 'GLA', 'GLB', 'GLC', 'GLE', 'GLS', 'Clase G', 'EQA', 'EQB', 'EQC', 'EQE', 'EQS', 'Sprinter', 'Vito'],
    'MG': ['MG5', 'MG ZS', 'MG HS', 'MG GT', 'MG RX5', 'MG4', 'Marvel R'],
    'Mini': ['Cooper', 'Cooper S', 'Countryman', 'Clubman', 'Convertible'],
    'Mitsubishi': ['Mirage', 'Attrage', 'Lancer', 'Eclipse Cross', 'Outlander', 'Montero', 'Pajero', 'L200', 'Xpander'],
    'Nissan': ['Versa', 'Sentra', 'March', 'Tiida', 'Tsuru', 'Altima', 'Maxima', 'Kicks', 'X-Trail', 'Pathfinder', 'Murano', 'Armada', 'Frontier', 'NP300', 'Titan', 'Urvan', 'Leaf', 'V-Drive', '370Z', '400Z', 'GT-R', 'Z'],
    'Omoda': ['C5', 'O5', 'O5 GT'],
    'Peugeot': ['208', '301', '308', '2008', '3008', '5008', 'Partner', 'Rifter', 'Expert', 'Manager'],
    'Porsche': ['911', '718 Boxster', '718 Cayman', 'Taycan', 'Panamera', 'Cayenne', 'Macan'],
    'RAM': ['700', '1500', '2500', '3500', '4000', 'ProMaster', 'ProMaster Rapid'],
    'Renault': ['Kwid', 'Sandero', 'Logan', 'Stepway', 'Duster', 'Oroch', 'Koleos', 'Captur', 'Megane E-Tech'],
    'SEAT': ['Ibiza', 'Leon', 'Arona', 'Ateca', 'Tarraco'],
    'Subaru': ['Impreza', 'Legacy', 'Outback', 'Forester', 'Crosstrek', 'Ascent', 'WRX', 'BRZ'],
    'Suzuki': ['Swift', 'Baleno', 'Ignis', 'Vitara', 'S-Cross', 'Ertiga', 'Ciaz', 'Jimny', 'Fronx', 'Grand Vitara', 'GSX-R600', 'GSX-R750', 'GSX-R1000', 'Hayabusa', 'GSX-S750', 'GSX-S1000', 'V-Strom 650', 'V-Strom 1050', 'SV650', 'Boulevard', 'DR650', 'Gixxer 150', 'Gixxer 250'],
    'Tesla': ['Model S', 'Model 3', 'Model X', 'Model Y', 'Cybertruck', 'Roadster'],
    'Toyota': ['Corolla', 'Camry', 'Prius', 'Yaris', 'Supra', 'RAV4', 'Highlander', 'Sienna', 'Tacoma', 'Tundra', 'Hilux', 'Avanza', 'C-HR', 'Corolla Cross', 'Sequoia', 'Land Cruiser', '4Runner', 'Hiace', 'Raize'],
    'Volkswagen': ['Jetta', 'Golf', 'Polo', 'Vento', 'Virtus', 'Passat', 'Arteon', 'Beetle', 'Tiguan', 'Taos', 'T-Cross', 'Nivus', 'Teramont', 'Touareg', 'Saveiro', 'Amarok', 'Crafter', 'Transporter', 'Caddy', 'ID.4', 'Gol', 'CrossFox', 'Polo Track'],
    'Volvo': ['S60', 'S90', 'V60', 'V90', 'XC40', 'XC60', 'XC90', 'C40', 'EX30', 'EX90'],

    // === MOTOCICLETAS ===
    'BMW Motorrad': ['G 310 R', 'G 310 GS', 'F 750 GS', 'F 850 GS', 'F 900 R', 'F 900 XR', 'S 1000 RR', 'S 1000 R', 'S 1000 XR', 'R 1250 GS', 'R 1250 RT', 'R 18', 'K 1600'],
    'Harley-Davidson': ['Street 750', 'Iron 883', 'Sportster S', 'Nightster', 'Softail Standard', 'Street Bob', 'Fat Boy', 'Heritage Classic', 'Road King', 'Street Glide', 'Road Glide', 'Ultra Limited', 'Pan America'],
    'Italika': ['FT150', 'FT125', 'DT150', 'DM200', 'DM250', 'WS150', 'DS150', 'Vort-X 200', 'Vort-X 300', 'Vort-X 650', 'Blackbird', 'TC250', 'SPTFIRE'],
    'Kawasaki': ['Ninja 400', 'Ninja 650', 'Ninja ZX-6R', 'Ninja ZX-10R', 'Ninja H2', 'Z400', 'Z650', 'Z900', 'Versys 650', 'Versys 1000', 'Vulcan S', 'KLR650', 'KX450'],
    'KTM': ['Duke 200', 'Duke 390', 'Duke 790', 'Duke 890', 'Duke 1290 Super Duke R', 'RC 200', 'RC 390', 'Adventure 390', 'Adventure 790', 'Adventure 1290 Super Adventure', '450 SX-F'],
    'Yamaha': ['YZF-R1', 'YZF-R6', 'YZF-R3', 'YZF-R7', 'YZF-R15', 'MT-03', 'MT-07', 'MT-09', 'MT-10', 'Tracer 9', 'Tracer 7', 'Tenere 700', 'Super Tenere', 'XMAX', 'NMAX', 'Bolt', 'V-Star']
}
