...
export const metadata: Metadata = {
    ...
    icons: {
        icon: [
            { url: "/favicon-v12.png", sizes: "32x32", type: "image/png" },
            { url: "/icon-192-v12.png", sizes: "192x192", type: "image/png" },
            { url: "/icon-512-v12.png", sizes: "512x512", type: "image/png" }
        ],
        apple: [
            { url: "/icon-192-v12.png" }
        ]
    }
};
